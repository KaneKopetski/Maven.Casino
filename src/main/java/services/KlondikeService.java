...
public class KlondikeService {
    ...
    public Boolean onePair(ArrayList<Integer> dice) {
    ...
    public Boolean twoPair(ArrayList<Integer> dice) {
        Collections.sort(dice);
    ...
    public Boolean threeOfAKind(ArrayList<Integer> dice) {
        Collections.sort(dice);
        for (int i = 0; i < 4; i++) {
    ...
    public Boolean fullHouse(ArrayList<Integer> dice) {
        // No need to sort because each method bellow already sorts
        return threeOfAKind(dice) && twoPair(dice);
    }

    public Boolean fourOfAKind(ArrayList<Integer> dice) {
        Collections.sort(dice);
        for (int i = 0; i < 3; i++) {
    ...
    public Boolean fiveOfAKind(ArrayList<Integer> dice) {
        Collections.sort(dice);
